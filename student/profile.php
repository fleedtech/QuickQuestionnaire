...
// check whether the admin old username and password truely exist in the database
						$sql_check_admin = "SELECT * FROM admin WHERE username='$username'";
						$query_check_admin = $con -> query($sql_check_admin);
						$num_rows_admin = mysqli_num_rows($query_check_admin);

						$sql_check_students = "SELECT * FROM student WHERE username='$username' AND password='$new_password'";
						...
						if ($num_rows_admin == true){
							...
							echo "
								...
								<br>
								<div class='fail_div'> 
									Sorry, the username you entered is being used by another user. Try another0000
								</div>
							";
...
// -------------------------------------------------------------------------------------------------------------------
								...
								$sql = "UPDATE student SET username='$username', password='$new_password' WHERE student_id='$student_id'";
								$query = $con -> query($sql);
